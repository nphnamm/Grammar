        ...
        {exercises.map((exercise) => (
          <li key={exercise.id}>
            <button
              ...
              className="w-full text-left py-4 px-6 bg-base-white border-2 border-base-black rounded-2xl shadow-md hover:bg-brand-green/60 transition duration-200 ease-in-out focus:outline-none font-medium text-lg font-sans"
            >
